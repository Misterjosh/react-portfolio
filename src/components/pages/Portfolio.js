                    ...
                    <article className="block">
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-6 col-md-12 col-lg-6">
                                ...
                                <p>This app uses <span className="spanb">HTML5</span>, <span className="spanb">CSS3</span>, <span className="spanb">JavaScript</span>, <span className="spanb">Bootstrap</span>, <span className="spanb">Local Storage</span>, and the <span className="spanb">Moment.js</span> library.
                                    It is a day planner that you can assign messages to.
                                </p>
                                <p>
                                    The image has an imbedded link to the app. The code is available on <a href="https://github.com/Misterjosh/Misterjosh.github.io/tree/master/Homework%2005%20-%20Weekday%20Scheduler%20(3rd%20Party%20APIs)" target="_blank" rel="noopener noreferrer">Github</a>.
                                </p>
                            </div>
                        </div>
                        <div className="row">
                        <div className="col-sm-6 col-md-12 col-lg-6">
                            ...
                            <div className="col-sm-6 col-md-12 col-lg-6">
                                ...
                                <p>This app uses <span className="spanb">HTML5</span>, <span className="spanb">JavaScript</span>, <span className="spanb">Bootstrap</span>, <span className="spanb">Local Storage</span>, <span className="spanb">Openweather API</span>, and <span className="spanb">Axios</span> to make API calls.
                                    It gets the weather by city. It displays the current weather, 5 day forcast, and UV index.
                                </p>
                                <p>
                                    The image has an imbedded link to the app. The code is available on <a href="https://github.com/Misterjosh/Misterjosh.github.io/tree/master/Homework-06-WeatherApp" target="_blank" rel="noopener noreferrer">Github</a>.
                                </p> 
                            </div>
                        </div>
                        <div className="row">
                        <div className="col-sm-6 col-md-12 col-lg-6">
                            ...
                            <div className="col-sm-6 col-md-12 col-lg-6">
                                ...
                                <p>This app uses <span className="spanb">HTML5</span>, <span className="spanb">CSS3</span> , <span className="spanb">JavaScript</span>, <span className="spanb">Bootstrap</span>, <span className="spanb">Yandex API</span>, <span className="spanb">Google Books API</span>, <span className="spanb">Giphy API</span>, and <span className="spanb">Axios</span> to make API calls.
                                    This app allows you to translate from English to Chinese or Spanish.
                                </p>
                                <p>
                                    The image has an imbedded link to the app. This was my first group project. We managed it poorly on Github and all the commits are under one person(not me). So, I uploaded a copy of our work to my repository. The code is available on <a href="https://github.com/Misterjosh/Misterjosh.github.io/tree/master/Project-1%20-translation-app" target="_blank" rel="noopener noreferrer">Github</a>.
                                </p> 
                            </div>
                        </div>
                        <div className="row">
